...
export const profileSchema = z.object({
  firstName: z
    .string()
    .trim()
    .min(1, { message: "O nome deve ser válido" })
    .optional()
    .or(z.literal(""))
  ...
  lastName: z
    .string()
    .trim()
    .min(1, { message: "O sobrenome deve ser válido" })
    .optional()
    .or(z.literal(""))
    .transform((v) => v || undefined),
  email: z
  ...
  phone: z
    .string()
    .trim()
    .min(1, { message: "O telefone deve ser válido" })
    .optional()
    .or(z.literal(""))
    .transform((v) => v || undefined),
  birthDate: z
    ...
    .transform((v) => v || undefined),
  gender: z
    .enum(["MALE", "FEMALE", "OTHER"], { message: "O gênero deve ser válido" })
    .optional()
    .or(z.literal(""))
    .transform((v) => v || undefined),
});
...
export type ProductOrderFormData = z.infer<typeof productOrderSchema>;
