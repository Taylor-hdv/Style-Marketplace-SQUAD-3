  ...
  return (
    <section className="flex flex-col items-center justify-center w-full h-full py-12 lg:py-32 md:w-md mx-auto px-4 gap-2 bg-[linear-gradient(135deg,rgba(243,244,246,0.30)_0%,rgba(243,244,246,0.10)_100%)]">
      <div className="flex flex-row gap-2 items-center ">
        ...
        <p className="text-blackCustom font-bold text-[1.5rem] font-segoe">
          STYLE
        </p>
      </div>
      <p className="text-grayCustom3 font-segoe text-center pb-6">
      ...
      <section className="flex flex-col items-center justify-center px-6 pb-6 w-full gap-6 bg-white rounded-xl shadow-[0_20px_25px_-5px_rgba(0,0,0,0.10),0_8px_10px_-6px_rgba(0,0,0,0.10)]">
        <div className="flex flex-col items-center justify-center w-full gap-1 pt-6">
          <h2 className="text-blackCustom font-segoe text-[1.5rem] font-bold text-center">
            Sign In
          </h2>
          <p className="text-grayCustom3 font-segoe text-center text-[0.988rem]">
            Enter your credencials to acess your account
          </p>
        </div>
        ...
        <div className="flex flex-row items-center justify-center w-full gap-2">
          ...
          <p className="text-grayCustom3 font-segoe text-[0.75rem] uppercase">
        ...
        >
          <div className="flex flex-col items-start justify-center w-full gap-[0.78rem] mb-[0.34rem]">
            ...
            <div className="flex flex-row justify-start items-center w-full px-3 py-3 border border-grayCustom bg-white gap-[0.8rem] rounded-xl">
              ...
              <input
                ...
                className="w-full text-[1rem] font-segoe text-grayCustom3 focus:outline-none"
              />
            </div>
            {errors.email && (
          ...
          <div className="flex flex-col w-full gap-2 mb-[0.34rem]">
            <div className="flex flex-row items-center justify-between w-full">
              ...
              <p
                className="text-blackCustom text-[0.875rem] font-segoe cursor-pointer"
            ...
            <div className="flex flex-row justify-start items-center w-full px-3 py-3 border border-grayCustom bg-white relative gap-[0.8rem] rounded-xl">
              ...
              >
                <img
                  src={showPassword ? visible : nonVisible}
        ...
        <p className="text-grayCustom3 font-segoe text-center font-semibold text-[0.875rem]">
          Don't have an account?{" "}
          <a
            className="text-blackCustom text-[0.875rem] text-center font-semibold cursor-pointer"
